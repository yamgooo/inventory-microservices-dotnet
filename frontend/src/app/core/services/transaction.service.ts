...
import { Transaction, CreateTransactionDto, UpdateTransactionDto, TransactionFilters } from '@core/services/interfaces/transaction.model';
...
export class TransactionService {
  ...
  updateTransaction(transaction: UpdateTransactionDto): Observable<ApiResponse<Transaction>> {
    return this.http.put<ApiResponse<Transaction>>(`${this.apiUrl}/update`, transaction);
  }
}